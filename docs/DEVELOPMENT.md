...
3. **Verify webhooks created:** Open System Console → Integrations → Incoming Webhooks → see entries named `<category>--testing-alerts-smoke` (the webhook name mirrors the receiver format `<base>--<team>-<channel>`).
