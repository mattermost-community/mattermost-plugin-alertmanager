...
description: General application performance benchmarking, regression detection and validation. Use for app-level benchmarks. For distributed consensus benchmarks, use consensus/performance-benchmarker instead.
